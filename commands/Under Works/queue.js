...
const Command = require(path.resolve("base", "Command"));
const Collector = require(path.resolve("utils", "reactionCollector"));

const { Command } = require('yuuko');

module.exports = new Command('queue', async (message, args, context) => {
